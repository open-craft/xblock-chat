...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'chat/translations'),
]

# statici18n
# http://django-statici18n.readthedocs.io/en/latest/settings.html

with open(os.path.join(BASE_DIR, 'chat/translations/config.yaml'), 'r') as locale_config_file:
...
STATICI18N_NAMESPACE = 'ChatXBlockI18N'
STATICI18N_PACKAGES = (
    'chat',
)
STATICI18N_ROOT = 'chat/public/js'
